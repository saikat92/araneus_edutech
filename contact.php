                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="contact-info-item mb-4">
                                ...
                                <div class="contact-details">
                                    <h5>Phone</h5>
                                    <p class="mb-0">
                                        <a href="tel:+919876543210" class="text-decoration-none"><?php echo SITE_PHONE; ?></a>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="contact-info-item mb-4">
                                ...
                                <div class="contact-details">
                                    <h5>Email</h5>
                                    <p class="mb-0">
                                        <a href="mailto:<?php echo SITE_EMAIL; ?>" class="text-decoration-none"><?php echo SITE_EMAIL; ?></a>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="contact-info-item mb-4">
                                ...
                                <div class="contact-details">
                                    <h5>LLPIN</h5>
                                    <p class="mb-0"><?php echo SITE_LLPIN; ?></p>
                                </div>
                            </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                We strive to respond to all inquiries within 24 hours during business days. For urgent matters, please call us directly at <?php echo SITE_PHONE; ?>.
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>If you have any questions about our privacy policy, please contact us at <?php echo SITE_EMAIL; ?>.</p>
            </div>
