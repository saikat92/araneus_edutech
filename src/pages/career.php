            ...
            <div class="col-lg-8 mx-auto">
                <div class="card border-0 shadow">
                    ...
                    <div class="card-body p-4 p-lg-5">
                        <form id="careerApplicationForm" action="core/career_application.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-lg-end">
                <a href="<?= DOMAIN; ?>education.php#internship" class="btn btn-light btn-lg px-5">Learn About Internships</a>
            </div>
        </div>
    </div>
</section>
