...
define('COMPANY_ADDRESS_GMAP', $_ENV['COMPANY_ADDRESS_GMAP'] ?? 'UNKNOWN_ADDRESS_GMAP');
define('COMPANY_LLPIN', $_ENV['COMPANY_LLPIN'] ?? 'UNKNOWN_LLPIN');
define('COMPANY_FACEBOOK', $_ENV['COMPANY_FACEBOOK'] ?? 'UNKNOWN_FACEBOOK');
define('COMPANY_INSTAGRAM', $_ENV['COMPANY_INSTAGRAM'] ?? 'UNKNOWN_INSTAGRAM');
define('COMPANY_GITHUB', $_ENV['COMPANY_GITHUB'] ?? 'UNKNOWN_GITHUB');
define('COMPANY_LINKEDIN', $_ENV['COMPANY_LINKEDIN'] ?? 'UNKNOWN_LINKEDIN');
define('COMPANY_YOUTUBE', $_ENV['COMPANY_YOUTUBE'] ?? 'UNKNOWN_YOUTUBE');
define('WEB_INDEXY', $_ENV['WEB_INDEXY'] ?? 'UNKNOWN_WEB_INDEXY');
